              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        openBrowser('https://sites.google.com/d/1V88_0M5fwBgxULq8u8d7-Z8JhiaEzYKn/p/1kFf-H5VK90Im9A1smmgaypgyMv9YJLx-/edit');
                      },
                      child: Text(
                    ...
                    InkWell(
                      onTap: () {
                        openBrowser('https://sites.google.com/d/1NeptNfx9pdamVa2ch8bgfKwkMdDKrPS0/p/13GWgESDuVACjfZym4nQdT8HonhwlEqSO/edit');
                      },
                      child: Text(
                    ...
                    InkWell(
                      onTap: () {
                        openBrowser('https://gixlwuuuovup.shuttls.com/');
                      },
                      child: Text(
                        languages[choosenLanguage]['text_about'],
                        style: GoogleFonts.roboto(
